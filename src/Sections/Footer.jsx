    ...
    <div className="flex justify-between items-start
     gap-20 flex-wrap max-lg:flex-col">
      <div className=" flex flex-col items-start">
        ...
        <p className=" mt-6 text-base font-montserrat
         leading-7 text-white-400 sm:max-w-sm">Get shoes ready for the new 
      ...
      <div className=" flex flex-1 justify-between 
       ...
       <div className=" flex justify-between text-white-400
        mt-24 max-sm:flex-col max-sm:items-center">
         ...
         items-center font-montserrat gap-2 cursor-pointer">
          <img
            src={copyrightSign}
            alt="Copy right sign"
            width={20}
